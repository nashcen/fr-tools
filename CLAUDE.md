...
以下 **10** 个文件/目录已**封板（FROZEN）**，绝对不允许修改、重命名、移动或删除内容：
...
## ⛔ GeoJSON 目录规范（v7.1 / v7.2 / v7.3 封板及后续新版本，CRITICAL）

`农业基地_v7.1_GCJ02_MultiPolygon/`、`农业基地_v7.2_GCJ02_MP_L2/`、`农业基地_v7.3_GCJ02_L3/`（**已封板**）及后续新版本采用 **area/point 分离**：
...
- v7.3（L3 四图，**当前生产**）：`.../农业基地_v7.3_GCJ02_L3/农业基地/浙江常山-area.json`

v6 / v7.0 封板仍用旧式 `农业基地_GCJ02_{基地}.json`；**v7.1 / v7.2 / v7.3 封板**仅允许 `*-area.json` + `*-point.json`，勿改动上述 **10** 项封板路径。
...
| KML 源文件 | `data/1.农业基地KML/` |
| 盘点 Excel | `data/农业资产盘点明细.xlsx` |
