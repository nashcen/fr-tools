"""
【版本快照 农业基地_v7.0_GCJ02_Polygon — 封板，勿改】
农业基地片区边界 GeoJSON 生成脚本
===================================
GCJ02_DIR → 农业基地_v7.0_GCJ02_Polygon（扁平 Polygon 四基地 json）
...
v7.0 主输出（扁平 Polygon，FVS geourl 用 农业基地_GCJ02_{CS,WS,BS,YY}.json）：

v7.2 L2 两层级（本快照 GCJ02_DIR 为 v7.0，下列 L2 结构仅作附带输出）：
...
GCJ02_DIR = (
    '/Applications/FineReport/webapps/webroot/WEB-INF'
    '/assets/map/geographic/农业基地-大疆测绘/农业基地_v7.0_GCJ02_Polygon'
)
